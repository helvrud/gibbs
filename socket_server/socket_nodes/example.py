...
request = []
for i in range(100):
    request.append(terminal.request(f'{i}', 0))
    request.append(terminal.request(f'sleep(0.01)', 1))
# %%
print ([request_ for request_ in request])
# %%
terminal.nodes[1].socket
# %%
terminal.request('True',0)
# %%
