...
\begin{equation*}
    ...
    c_s^\prime =\frac{- V c_{s} \left(V - V_{gel}\right) - \frac{\alpha \left(V - V_{gel}\right)}{2} + \sqrt{V^{2} V_{gel}^{2} c_{s}^{2} + V V_{gel}^{2} \alpha c_{s} + \frac{\alpha^{2} \left(V - V_{gel}\right)^{2}}{4}}}{V_{gel}^{2} - \left(V - V_{gel}\right)^{2}}
