...
By the \emph{open system} we mean that the gel is equlibrated with an \textbf{infinite} reservoir outside, such that there are the same ions chemical potential, the same temperature and desired pressure difference between the gel and the reservoir. Number of  $\na$ and $\cl$ ions and gel volume $\Vgel$ are allowed to change.

By the \emph{closed system} we mean that the gel is equlibrated with a \textbf{finite} reservoir, in this case after equilibration the gel and the reservoir again have the same ions chemical potential, the same temperature and desired pressure difference between the gel and the reservoir. 
...
For the MD part of emph{closed system} simulation analougous simulation box is created without any polymer monomers.
