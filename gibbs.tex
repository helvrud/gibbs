...
\newcommand{\Vgeleq}{\widetilde{\Vgel}}
...
The insoluble cross-linked network of the gel enables dewatering under the influence of a stimulus (thermal and/or mechanical) \todo{remove this sentence?}.
On the other hand, the network structure of a polymer hydrogel, from a thermodynamic
...
We modeled the thermodynamic equilibrium of coexisting gel and aqueous salt solution phases in the so-called `closed' ensemble, in which the total amount of ions is assumed to be constant. 
We modeled the compression of the gel associated with the release of solution and have shown that the squeezed-out solution has a little lower salinity than the one the gel was equilibrated with. 
Finally, we performed a set of simulations modeling the process of continuous decrease of water salinity up to freshwater concentrations.
\end{abstract}
...
We demonstrated the desalination process composed of a cascade of following one by each other gel swellings and compressions driving the salinity of gel supernate down to drinkable water. 
