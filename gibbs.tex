...
\end{equation}
where $i \in \{\na, \cl\}$,  $N_i$ is the amount of the corresponding ions in gel, $\Vgel$~--- volume of the gel, $\Vbox$~--- the volume in which the gel is compressed. As $\Vbox$ we choose the volume of the gel in the free swelling equilibrium state.
...
The dependencies of $\Pgel$ on the gel molar volume $\Vgel$ are present in Figure \ref{fig: PV} for a set of different salinities. \todo{consider treplacing $\Pgel$ by $\Pi$}
