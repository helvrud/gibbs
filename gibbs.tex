...
In this article, we present our recent theoretical study of the usage of polyelectrolyte hydrogel for water desalination. 
Using coarse-grained model and the Gibbs ensemble, we modeled the thermodynamic equilibrium between coexisting phases of the gel and corresponding supernate aqueous 
salt solution.
...
while the compression in \emph{clesed system} causes the decrease of the supernatant solution.
We modeled this stepwise process of continuous decrease of seawater salinity up to freshwater concentrations.
