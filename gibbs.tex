...
the total number of ions (in gel and in reservoir) is constant.

Due to huge size of the reservoir, the compression of the gel in the \emph{open system} does not affect the reservoir salinity, $\cs =$ $\cna=$ $\ccl=$ $\text{Const}$ (\reffig{fig: open}), whereas the number of ions entrapped in the volume $\Vbox$ changes.
