...
TODO put here the parts from "Results and Discussion", which are actually neither Results nor Discussion
\paragraph{Compression in the \emph{open system}}
\paragraph{Compression in the \emph{closed system}}
