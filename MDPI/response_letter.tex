...
The method idea is outlined in the paragraph "Physics behind the desalination process" and described in the section "Theory behind the simulation". Some more technical issues are in ESI.
